...
namespace UnityEditor.Audio
{
	...
	{
		private static Assembly unityEditorAssembly => null; //typeof(AudioImporter).Assembly; 
		private static Type audioUtilClass => null; //unityEditorAssembly.GetType("UnityEditor.AudioUtil");
